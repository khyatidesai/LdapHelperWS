/**
 * LdapHelperCallbackHandler.java
 *
...
/**
 * LdapHelperCallbackHandler Callback class, Users can extend this class and
 * implement their own receiveResult and receiveError methods.
 */
public abstract class LdapHelperCallbackHandler {
	 ...
	 */
	public LdapHelperCallbackHandler(Object clientData) {
	 ...
	 */
	public LdapHelperCallbackHandler() {
	 ...
	 */
	public void receiveResultupdate(org.intalio.ldaphelper.UpdateResponse result) {
	}
	 ...
	 */
	public void receiveResultquery(org.intalio.ldaphelper.QueryResponse result) {
	}
