...
public class Update implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(
		...
		localOperation.serialize(
				new javax.xml.namespace.QName("", "Operation"), factory,
				xmlWriter);
		...
		public static Update parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
						...
						if (!"Update".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (Update) org.intalio.ldaphelper.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setOperation(org.intalio.ldaphelper.Operation.Factory
							.parse(reader));
