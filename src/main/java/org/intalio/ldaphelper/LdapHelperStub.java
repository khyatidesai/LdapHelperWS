...
public class LdapHelperStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService("LdapHelper"
				+ getUniqueSuffix());
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://bpms.intalio.org/LdapHelper/", "update"));
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://bpms.intalio.org/LdapHelper/", "query"));
		_service.addOperation(__operation);
	 ...
	 */
	public LdapHelperStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback.receiveResultupdate((org.intalio.ldaphelper.UpdateResponse) object);
					...
					public void onMessage(
						...
						try {
							...
							java.lang.Object object = fromOM(resultEnv
									...
									org.intalio.ldaphelper.QueryResponse.class,
									getEnvelopeNamespaces(resultEnv));
							callback.receiveResultquery((org.intalio.ldaphelper.QueryResponse) object);
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
		...
		try {
			...
			emptyEnvelope.getBody().addChild(
					param.getOMElement(org.intalio.ldaphelper.Update.MY_QNAME,
							factory));
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
		...
		try {
			...
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory
					.getDefaultEnvelope();
			emptyEnvelope.getBody().addChild(
					param.getOMElement(org.intalio.ldaphelper.Query.MY_QNAME,
							factory));
			return emptyEnvelope;
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
