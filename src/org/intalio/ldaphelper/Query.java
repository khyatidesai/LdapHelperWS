                ...
                if (localSearchBaseTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"searchBase", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);
                                            ...
                                            if (localReturns[i] != null){
                                                ...
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        ...
                                                        xmlWriter.writeStartElement(prefix2,"Returns", namespace);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Query".equals(type)){
                                ...
                                return (Query)org.intalio.ldaphelper.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    list2.add(org.intalio.ldaphelper.Item.Factory.parse(reader));
                                                        ...
                                                        object.setParameters((org.intalio.ldaphelper.Item[])
